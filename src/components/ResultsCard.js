            ...
            {players[1] && (
              ...
              >
                <div style={{
                  ...
                  <div style={{ fontWeight: 'bold', fontSize: '0.95rem', color: '#1f2937', marginBottom: '0.4rem' }}>
                    {players[1].name}
                  </div>
                  <div style={{ fontSize: '1.4rem', fontWeight: 'bold', color: getPositionStyle(2).textColor }}>
            ...
            {players[0] && (
              ...
              >
                <div style={{
                  ...
                  <div style={{ fontWeight: 'bold', fontSize: '1.1rem', color: '#1f2937', marginBottom: '0.5rem' }}>
                    {players[0].name}
                  </div>
            ...
            {players[2] && (
              ...
              >
                <div style={{
                  ...
                  <div style={{ fontWeight: 'bold', fontSize: '0.9rem', color: '#1f2937', marginBottom: '0.4rem' }}>
                    {players[2].name}
                  </div>
                  <div style={{ fontSize: '1.25rem', fontWeight: 'bold', color: getPositionStyle(3).textColor }}>
                ...
                {players.slice(3).map((player, index) => (
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      ...
                      <div style={{ fontWeight: 'bold', fontSize: '1rem', color: '#ffffff' }}>
                        {player.name}
                      </div>
                    </div>
                    <div style={{ 
