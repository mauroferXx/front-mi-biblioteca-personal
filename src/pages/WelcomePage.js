...
import { BookOpen, Brain, Trophy, Award } from 'lucide-react';
    ...
    <div className="min-h-full" style={{ backgroundColor: '#f3f4f6' }}>
      <div className="container" style={{ paddingTop: '2rem', paddingBottom: '2rem' }}>
        ...
        <div className="grid-3" style={{ marginBottom: '2rem' }}>
          ...
          <motion.div
            className="card"
            style={{ padding: '1.5rem', borderTop: '4px solid #6366f1', cursor: 'pointer' }}
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <span className="text-xs" style={{ color: '#10b981', fontWeight: 600 }}>Disponible</span>
            </div>
          </motion.div>
          ...
          <motion.div
            className="card"
            style={{ padding: '1.5rem', borderTop: '4px solid #10b981', cursor: 'pointer' }}
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <span className="text-xs" style={{ color: '#16a34a', fontWeight: 600 }}>Disponible</span>
            </div>
          </motion.div>
          ...
          <motion.div
            className="card"
            style={{ padding: '1.5rem', borderTop: '4px solid #f59e0b', cursor: 'pointer' }}
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
              <Trophy className="w-5 h-5" color="#f59e0b" />
        ...
        <div style={{ marginBottom: '2rem' }}>
          <motion.div
            className="card"
            style={{ padding: '1.5rem', borderTop: '4px solid #8b5cf6', cursor: 'pointer' }}
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
              <Award className="w-5 h-5" color="#8b5cf6" />
              <h3 className="text-xl font-bold text-gray-800">Logros</h3>
            </div>
            <p className="text-gray-500 text-sm" style={{ marginBottom: '1rem' }}>
              Desbloquea logros y demuestra tu dedicación. Compite por ser el mejor lector.
            </p>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <button 
                onClick={(e) => {
        ...
        <motion.div
          ...
          style={{ padding: '1.5rem', background: 'linear-gradient(135deg, #f9fafb 0%, #f3f4f6 100%)' }}
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <p className="text-gray-600 mb-4">
            Explora todas las funcionalidades disponibles. Juega trivia, gestiona tu biblioteca, sube de nivel y desbloquea logros.
          </p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }} className="sm:flex-row">
            <button
              onClick={() => navigate('/trivia')}
              className="btn btn-primary"
              style={{ borderRadius: '9999px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}
            >
            ...
            <button
              onClick={() => navigate('/library')}
              className="btn"
              style={{ background: '#f3f4f6', color: '#374151', fontWeight: 600, borderRadius: '9999px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}
            >
